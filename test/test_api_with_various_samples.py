...
def test_api_with_various_samples():
    ...
    for i in range(5):
        ...
        sample_data = data.sample(n=10, random_state=i)  # Sélectionner 10 lignes aléatoires
        ...
        # Afficher la réponse
        print(f"Response for sample {i}:", response.json())

if __name__ == "__main__":
    test_api_with_various_samples()
